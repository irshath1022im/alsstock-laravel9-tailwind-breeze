   ...
   @endcomponent
    ...
    <form class="px-2 my-3">
        <div class="my-2">
            ...
            <input type="text" wire:model.defer="item" class="block w-full rounded-md" />
        </div>
        ...
        <div class="my-2">
            ...
            <input type="file" wire:model="thumbnail" class="block w-full rounded-md" />
        </div>
        ...
        @if ($mode !== 'edit')
            ...
            <button
                ...
                type="button"
                class="border bg-blue-600 text-sm p-2 hover:bg-sky-700 hover:text-white rounded-lg">SUBMIT
            </button>
