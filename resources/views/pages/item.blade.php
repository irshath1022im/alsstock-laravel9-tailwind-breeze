        ...
        <div class="grid grid-cols-12">
            ...
            <div class=" col-span-12 sm:col-span-9 m-2 rounded-lg border flex flex-col items-center bg-slate-100">
                ...
                <div class="mb-1">
                    ...
                    <button type="button" class="inline-flex items-center px-5 py-2.5 text-small font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-blue-300">
